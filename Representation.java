...
public class Representation {
    ...
    protected void creation(String jour, String heure, boolean annulée,Spectacle s) {
    	Representation one = new Representation(jour, heure, annulée, s);
    }
    
    protected void creation(String jour, String heure, boolean annulée,String nom, Integer duree, Integer nbreMaxSpect, String genre,Representation represente,Zone salle) {
    	Spectacle two = new Spectacle( nom,  duree, nbreMaxSpect, genre,this,salle);
    	Representation one = new Representation(jour, heure, annulée, two);
    }
    
    protected void creation(Representation r ,String nom, Integer duree, Integer nbreMaxSpect, String genre,Zone salle) {
    	Spectacle two = new Spectacle( nom,  duree, nbreMaxSpect, genre,r,salle);
    }
